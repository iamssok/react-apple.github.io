...
import StoreSlide from './Store-slide';
import { StoreNavWrapper, ProductNavWrapper } from '../styles/Store.styled';
...
function Store() {
  ...
  return (
    <>
      <StoreNavWrapper className="d-flex flex-space-between">
        <h2 className="top-tit"><span>스토어. </span>좋아하는 Apple 제품을 구입하는 가장 좋은 방법.</h2>
        <div>
          <div className="d-flex chat">
            <img widht="35" height="35" src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/store-chat-specialist-icon-202309_AV1?wid=35&hei=35&fmt=jpeg&qlt=95&.v=1701194050273" alt="스페셜리스트에게 문의하세요" />
            <div>
              <p>쇼핑 지원이 필요하다면?</p>
              <Link to="" onClick={handleClick}>스페셜리스트에게 문의하세요</Link>
            </div>
          </div>
          <div className="d-flex chat">
            <svg width="35" height="35" viewBox="0 0 25 35">
            ...
            <div>
              ...
              <Link to="" onClick={handleClick}>가까운 매장 찾기</Link>
            </div>
          </div>
        </div>
      </StoreNavWrapper>
      <ProductNavWrapper className="d-flex">
        <Link to="" onClick={handleClick} className="product-nav">
        ...
        <Link to="" onClick={handleClick} className="product-nav">
          <img src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/store-card-13-ipad-nav-202210?wid=400&amp;hei=260&amp;fmt=png-alpha&amp;.v=1664912135437" alt="iPad" />
          <p>iPad</p>
        </Link>
        <Link to="" onClick={handleClick} className="product-nav">
          <img src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/store-card-13-iphone-nav-202309?wid=400&amp;hei=260&amp;fmt=png-alpha&amp;.v=1692971740452" alt="iPhone" />
          <p>iPhone</p>
        </Link>
        <Link to="" onClick={handleClick} className="product-nav">
          <img src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/store-card-13-watch-nav-202309_GEO_KR?wid=400&amp;hei=260&amp;fmt=png-alpha&amp;.v=1693703814022" alt="Apple Watch" />
          <p>Apple Watch</p>
        </Link>
        <Link to="" onClick={handleClick} className="product-nav">
          <img src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/store-card-13-airpods-nav-202209?wid=400&amp;hei=260&amp;fmt=png-alpha&amp;.v=1660676485885" alt="AirPods" />
          <p>AirPods</p>
        </Link>
        <Link to="" onClick={handleClick} className="product-nav">
        ...
        <Link to="" onClick={handleClick} className="product-nav">
          <img src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/store-card-13-accessories-nav-202403?wid=400&amp;hei=260&amp;fmt=png-alpha&amp;.v=1707850611597" alt="액세서리" />
          <p>액세서리</p>
        </Link>
      </ProductNavWrapper>
      <StoreSlide />
